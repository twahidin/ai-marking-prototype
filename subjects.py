...
# Order here is the order the dropdown shows them in. Sciences first,
# then maths, then languages/literature, then humanities, then aesthetics
# and applied, then mother tongues — matches how a teacher's mental model
# typically scans a subject menu.
SUBJECTS = [
    {'key': 'lower_secondary_science', 'display': 'Lower Secondary Science',
     'aliases': ['lower secondary science', 'lower sec science', 'lss',
                 'science', 'general science', 'biology', 'bio']},
